...
const CASES = [
  ...
  {
    name: "gasless stablecoin payment to a named recipient",
    outcome: {
      kind: 5,
      inputToken: A(0x11),
      ...
      recipient: A(0xcafe),
      maxSlippageBps: 0,
      legs: [{ token: A(0x11), weightBps: 10_000, minOut: 500_000_000n }],
      exits: [],
    },
    policy: {
      maxNotional: 500_000_000n,
      validAfter: 0n,
      validUntil: 1_800_090_000n,
      maxFeeBps: 0,
      minReputationBps: 0,
